...
/**
 * Custom Landing Page for Hero Cooperative
 * Tenant ID: hero
 * Cooperative Type: conventional
 * 
...
export default function HeroLandingPage() {
  ...
  const faqs = [
    {
      q: "Who is eligible to join Hero Cooperative?",
    ...
    {
      q: "What are the interest rates and repayment terms on loans?",
      a: "Our loans offer competitive, cooperative-standard rates with flexible repayment terms designed to support member development rather than commercial profit."
    },
    {
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-emerald-500 selection:text-white">
      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            <a
              href="/login?tenant=hero"
              className="px-4 py-2 text-sm font-medium text-slate-700 hover:text-slate-900 hover:bg-slate-100 rounded-lg transition-colors"
            >
              Sign In
            </a>
            <a
              href="/apply-membership?tenant=hero"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto space-y-6">
            <div className="inline-flex items-center space-x-2 bg-emerald-50 border border-emerald-200/80 px-3.5 py-1.5 rounded-full text-xs font-semibold text-emerald-800 shadow-sm">
              ...
              <span>🤝 Member-Owned Cooperative Society</span>
            </div>

            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-slate-900 tracking-tight leading-[1.1]">
              Welcome to <span className="text-primary-600">Hero Cooperative</span>
            </h1>
      ...
      <section id="services" className="py-20 bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
            ...
            <p className="text-slate-600 text-base">Democratic, Community-Driven & Rewarding Cooperative Banking</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">High-Yield Member Savings</h3>
              <p className="text-slate-600 text-sm leading-relaxed">Build wealth through disciplined monthly contributions and competitive interest returns.</p>
            </div>
            ...
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Low-Interest Credit Loans</h3>
              <p className="text-slate-600 text-sm leading-relaxed">Apply for development, emergency, and venture loans with member-friendly repayment terms and fast approvals.</p>
            </div>
            ...
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Annual Dividends & Surplus</h3>
              <p className="text-slate-600 text-sm leading-relaxed">Receive your fair share of annual cooperative surpluses and dividends based on your equity contributions.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-900 text-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 space-y-6">
          <h2 className="text-3xl sm:text-5xl font-extrabold tracking-tight">
            Ready to build wealth with Hero Cooperative?
          </h2>
      ...
      <footer className="bg-slate-950 text-slate-400 py-12 border-t border-slate-800 text-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            <p className="font-semibold text-white">Hero Cooperative</p>
            <p className="text-xs text-slate-500 mt-0.5">© {new Date().getFullYear()} Hero Cooperative. All rights reserved.</p>
          </div>
          <div className="flex items-center space-x-6 text-xs text-slate-500">
            <a href="/login?tenant=hero" className="hover:text-white transition">Member Login</a>
            <a href="/apply-membership?tenant=hero" className="hover:text-white transition">Apply for Membership</a>
          </div>
        </div>
      </footer>
    </div>
